...
var patrol_points = [Vector2(-30, 40), Vector2(-30, -80)]
...
#func agent_nav(target_position, delta):
	...
	#var vel = direction * movementSpeed * delta
	#
	## Update RayCast2D direction
	#ray_cast_2d.target_position = direction * RAY_LEN_MAX  # Adjust the length as needed
